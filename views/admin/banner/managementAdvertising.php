                                        ...
                                        if ($getAllAdvertisingBanner) {
                                            foreach ($getAllAdvertisingBanner as $key => $item) {
                                                ...
                                                <tr id="deleteBanner<?php echo $item['id']?>">
                                                    ...
                                                    <td id="statusAdvertising<?= $item['id'] ?>">
                                                        <?php
                                                        if ($item['status'] == 2) {
                                                            ?>
                                                            <span class="switch switch-icon">
                                                                    <label>
                                                                        <input id="changeStatusInput<?= $item['id'] ?>"
                                                                               onclick="statusAdvertising(<?= $item['id'] ?>, 1)"
                                                            ...
                                                            <span class="switch switch-icon">
                                                                    <label>
                                                                        <input
                                                                            ...
                                                                            onclick="statusAdvertising(<?= $item['id'] ?>, 2)"
                                                    ...
                                                    <td style="min-width:110px;">
                                                        <a href="<?= url("/admin/banner/updateAdvertising?id={$item['id']}") ?>"
                                            ...
                                            <div class="alert alert-warning col-12 col-md-12">
                                                <h3 class="text-center">
                                                    هیچ بنر های تبلیغاتی وجود ندارد
                                                </h3>
                                            </div>
                                            <?php
                                        }
...
<!--end::Content-->
<?php
$pageTitle = "مدیریت بنر های تبلیغاتی ";
$pageScript = "
