                                            ...
                                            foreach ($getAllBanner as $key => $item) {
                                                ...
                                                <tr id="deleteBanner<?php echo $item['id']?>">
                                                            ...
                                                            <span class="switch switch-icon">
                                                                    <label>
                                                                        <input id="changeStatusInput<?= $item['id'] ?>"
                                                                               onclick="statusBanner(<?= $item['id'] ?>, 1)"
                                                            ...
                                                            <span class="switch switch-icon">
                                                                    <label>
                                                                        <input
                                                                            ...
                                                                            onclick="statusBanner(<?= $item['id'] ?>, 2)"
                                                    ...
                                                    <td style="min-width:110px;">
                                                        <a href="<?= url("/admin/banner/update?id={$item['id']}") ?>"
                                                        ...
                                                        <button type="button" onclick="delteBanner(<?= $item['id'] ?>)" class="btn btn-icon btn-danger btn-sm mr-2 " data-toggle = "tooltip" title = "حذف" data-theme = "dark">
