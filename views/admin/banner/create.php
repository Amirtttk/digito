    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="card-label">ایجاد بنر </h5>
                <!--end::Page Title-->
            </div>
            <!--end::اطلاعات-->
        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">ایجاد بنر جدید </h3>
                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="row">
                                                    <label class="upload-file p-3 w-100 d-flex align-items-center" style="column-gap: 10px">
                                                        ...
                                                        <input name="image" data-v-message="تصویر بنر نمیتواند خالی بماند"
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input name="link" type="text" class="form-control"
                                                       data-v-message="لینک بنر نمیتواند خالی بماند" required
                                                       placeholder="عنوان بنر را وارد کنید" />
                                            </div>
                                            <div class="col-lg-4">
                                                <label>نوع بنر :</label>
                                                <select class="form-control selectpicker" tabindex="null" name="type">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <button type="button" class="btn btn-success mr-2"
                                                        onclick="createBanner()">ایجاد</button>
