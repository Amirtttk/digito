<?php
$getOneBanner = getOneAdvertising(GET('id'));
?>
<!--begin::Content-->
    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <!--begin::Page Title-->
                <h5 class="card-label"> ویرایش  بنر تبلیغ محصول</h5>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label"> ویرایش  بنر تبلیغ محصول</h3>
                        </div>
                                ...
                                <div class="tab-pane fade show active" id="kt_tab_pane_7_1" role="tabpanel" aria-labelledby="kt_tab_pane_7_1">
                                    <form id="">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button type="button" class="btn btn-success mr-2" onclick="updateBannerAdvertising(<?php echo $_GET["id"]; ?>)">ویرایش اطلاعات</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <form id="myform">
                                        <div class="row p-3">
                                            <label class="upload-file py-3 w-100">
                                                ...
                                                <input onchange="updateImageAdvertising(<?php echo $_GET['id'] ?>)"
...
<?php
$pageTitle = " ویرایش  بنر تبلیغ محصول";
$pageScript = "
