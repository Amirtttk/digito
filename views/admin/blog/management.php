                                        ...
                                        if ($getAllBlog) {
                                            foreach ($getAllBlog as $key => $AllBlog) {
                                                ...
                                                <tr id="deleteBlog<?php echo $AllBlog['id']?>">
                                                    ...
                                                    <td style="min-width:80px;" id="statusShow<?= $AllBlog['id'] ?>">
                                                        <?php
                                                        if ($AllBlog['status'] == 1) {
                                                            ?>
                                                            <span
                                                    ...
                                                    <td id="statusBlog<?= $AllBlog['id'] ?>">
                                                        <?php
                                                        if ($AllBlog['status'] == 2) {
                                                            ?>
                                                            <span class="switch switch-icon">
                                                                    <label>
                                                                        <input id="changeStatusInput<?= $AllBlog['id'] ?>"
                                                                               onclick="statusBlog(<?= $AllBlog['id'] ?>, 1)"
                                                            ...
                                                            <span class="switch switch-icon">
                                                                    <label>
                                                                        <input
                                                                                id="changeStatusInput<?= $AllBlog['id'] ?>"
                                                                                onclick="statusBlog(<?= $AllBlog['id'] ?>, 2)"
                                                    ...
                                                    <td style="min-width:110px;">
                                                        <a href="<?= url("/admin/blog/update?id={$AllBlog['id']}") ?>"
                                                        ...
                                                        <button type="button" onclick="delteBlog(<?= $AllBlog['id'] ?>)" class="btn btn-icon btn-danger btn-sm mr-2 " data-toggle = "tooltip" title = "حذف" data-theme = "dark">
