              ...
              <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
                  <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                      ...
                      <div class="d-flex align-items-center flex-wrap mr-2">
                          <!--begin::Page Title-->
                          <h5 class="card-label">ایجاد برند </h5>
                          <!--end::Page Title-->
                      </div>
                      <!--end::اطلاعات-->
                  </div>
                          ...
                          <div class="card card-custom">
                              <div class="card-header">
                                  <div class="card-title">
                                      ...
                                      <h3 class="card-label">ایجاد برند جدید </h3>
                                  </div>
                                              ...
                                              <div class="card-body">
                                                  <div class="form-group row">
                                                      <div class="col-lg-4">
                                                          ...
                                                          <input name="title" type="text" class="form-control" data-v-message="عنوان  نمیتواند خالی بماند" required placeholder="عنوان  را وارد کنید" />
                                                      </div>
                                                      <div class="col-lg-4">
                                                  ...
                                                  <div class="row">
                                                      <div class="col-lg-6">
                                                          <button type="button" class="btn btn-success mr-2"
                                                              onclick="createBrand()">ایجاد</button>
