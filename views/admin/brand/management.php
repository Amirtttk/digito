                                            ...
                                            if ($getAllBrand) {
                                                foreach ($getAllBrand as $key => $AllBrand) {
                                                    ...
                                                    <tr id="deleteHonors<?php echo $AllBrand['id']?>">
                                                        ...
                                                        <td id="statusHonors<?= $AllBrand['id'] ?>">
                                                            <?php
                                                            if ($AllBrand['status'] == 2) {
                                                                ?>
                                                                <span class="switch switch-icon">
                                                                    <label>
                                                                        <input id="changeStatusInput<?= $AllBrand['id'] ?>"
                                                                            onclick="statusBrand(<?= $AllBrand['id'] ?>, 1)"
                                                                ...
                                                                <span class="switch switch-icon">
                                                                    <label>
                                                                        <input
                                                                            id="changeStatusInput<?= $AllBrand['id'] ?>"
                                                                            onclick="statusBrand(<?= $AllBrand['id'] ?>, 2)"
                                                        ...
                                                        <td>
                                                            <a href="<?= url("/admin/brand/update?id={$AllBrand['id']}") ?>"
