        ...
        <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <!--begin::Page Title-->
                    <h5 class="card-label">ویرایش اطلاعات درباره ما  </h5>
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">ویرایش اطلاعات درباره ما</h3>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button type="button" class="btn btn-success mr-2"
                                                                onclick="updateAboutUs(<?= '1' ?>)">ویرایش </button>
                                        ...
                                        <form id="myformImageBrand">
                                            <div class="row p-3">
                                                <label class="upload-file py-3 w-100">
                                                    ...
                                                    <input onchange="updateImageAboutUs(<?= $_GET['id'] ?>)"
