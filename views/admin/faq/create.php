    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="card-label">ایجاد سوال متداول جدید </h5>
                <!--end::Page Title-->
            </div>
            <!--end::اطلاعات-->
        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">ایجاد سوال متداول و قوانین  </h3>
                        </div>
                        <div class="card-toolbar">
                            <ul class="nav nav-tabs nav-bold nav-tabs-line">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#kt_tab_pane_7_1">
                                        <span class="nav-icon"><i class="fa fa-info"></i></span>                                        اطلاعات سوال متداول و قوانین </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <button type="button" class="btn btn-success mr-2"
                                                        onclick="createFaq()">ایجاد</button>
...
<!--end::Content-->
<?php
$pageTitle = "ایجاد سوال متداول جدید ";
$pageScript = "
