      ...
      <div class="lg:w-9/12 border border-zinc-200 rounded-xl p-5">
              ...
              <div class="space-y-5">
                <ul class="w-full flex flex-col gap-3">
                  <li>
                    ...
                    <label for="15" class="block w-full p-2 text-gray-600 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-zinc-500 peer-checked:border-2 peer-checked:text-zinc-600 opacity-70 peer-checked:opacity-100">                           
                      <div>
                  ...
                  <li>
                    ...
                    <label for="16" class="block w-full p-2 text-gray-600 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-zinc-500 peer-checked:border-2 peer-checked:text-zinc-600 opacity-70 peer-checked:opacity-100">                           
                      <div>
                        <div class="border-b border-b-zinc-400 p-3 text-zinc-800 text-sm flex justify-between items-center">
                          خراسان رضوی - سبزوار
                        </div>
        ...
        <div class="sm:flex gap-x-5">
          <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
            ...
            <input class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="نام">
          </div>
          <div class="sm:w-1/2 flex flex-col gap-y-1">
            ...
            <input class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="نام خانوادگی">
          </div>
        </div>
        <div class="sm:flex gap-x-5 mt-7">
          <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
            ...
            <select name="select" class="appearance-none rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300">
              <option value="">-</option>
        ...
        <div class="mt-7">
          <div class="flex flex-col gap-y-1">
            ...
            <input class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="اطلاعات دقیق محل تحویل">
          </div>
        </div>
        <div class="sm:flex gap-x-5 mt-5">
          <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
            ...
            <input class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="تلفن همراه">
          </div>
          <div class="sm:w-1/2 flex flex-col gap-y-1">
            <label class="text-zinc-700 flex">
              کد پستی
            ...
            <input class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="کد پستی محل تحویل">          
          </div>
        </div>
        <div class="mt-5">
          <div class="flex flex-col gap-y-1">
