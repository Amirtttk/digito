...
<main class="p-6 flex-1 overflow-y-auto">
      <div class="bg-white rounded-2xl min-h-80 h-auto shadow-custom p-4">
        ...
        <div class="lg:w-10/12 mx-auto py-5 text-sm md:text-base">
          <div class="sm:flex gap-x-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <input name="userFullName" value="<?= $getInfoUser['userFullName'] ?>" class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="نام و نام خانوادگی">
            </div>
              <div class="sm:w-1/2 flex flex-col gap-y-1">
                  ...
                  <input disabled value="09<?= $getInfoUser['userMobile'] ?>" class="rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300" type="text" placeholder="شماره تماس">
              </div>
          </div>
          <div class="sm:flex gap-x-5 mt-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <select name="gender"  class="appearance-none rounded-2xl rounded-tr-sm text-sm text-zinc-600 w-full bg-[#f0f0f0] px-5 py-3.5 placeholder:text-zinc-400 placeholder:text-xs focus:outline-1 focus:outline-zinc-300">
                  <?php
          ...
          <a onclick="updateInfoUser()" id="btnUpdateInfo" class="block text-center w-full md:w-4/12 mx-auto px-2 py-3 mt-10 text-sm bg-gradient-to-bl from-primary-500 to-primary-700 hover:opacity-80 transition text-gray-100 rounded-lg">
            ثبت اطلاعات
          </a>
        </div>
      </div>
